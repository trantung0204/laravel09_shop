...
<html lang="en">
	...
	<body class="index">				  
				...
				<div class="tp-banner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="{{ asset('shop_assets/') }}/images/slides/slide-1.jpg"  alt="slide1"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" > 
							<!-- LAYERS --> 
							<!-- TEXT -->
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="{{ asset('shop_assets/') }}/images/slides/slide-2.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS -->
							<!-- TEXT -->
						...
						<!-- SLIDE - 3 -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
										<img src="{{ asset('shop_assets/') }}/images/slides/04/intro_img_03.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
									<!-- LAYER NR. 1 -->
									<div class="tp-caption tp-fade fadeout fullscreenvideo"
										...
										<video class="video-js vjs-default-skin" preload="none" 
											poster='{{ asset('shop_assets/') }}/images/slides/video/video_img.jpg' data-setup="{}">
											<source src='{{ asset('shop_assets/') }}/images/slides/video/explore.mp4' type='video/mp4' />
											<source src='{{ asset('shop_assets/') }}/images/slides/video/explore.webm' type='video/webm' />
											<source src='{{ asset('shop_assets/') }}/images/slides/video/explore.ogv' type='video/ogg'  />
										</video>
						...
						<div class="category-carousel">
							<div class="col-sm-4 col-md-4 col-lg-4">
								<a href="{{ asset('shop_assets/') }}/listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/category-3.jpg" alt=""/>
							...
							<div class="col-sm-4 col-md-4 col-lg-4">
								<a href="{{ asset('shop_assets/') }}/listing.html" class="banner zoom-in">
								<span class="figure">
									<img src="{{ asset('shop_assets/') }}/images/custom/category-2.jpg" alt=""/>
									<span class="figcaption">
										<span class="block-table">
											<span class="block-table-cell">
							...
							<div class="col-sm-4 col-md-4 col-lg-4">
								<a href="{{ asset('shop_assets/') }}/listing.html" class="banner zoom-in">
								<span class="figure">
									<img src="{{ asset('shop_assets/') }}/images/custom/category-1.jpg" alt=""/>
									<span class="figcaption">
										<span class="block-table">
											<span class="block-table-cell">
				...
				<div class="container">
					<div class="row">
											...
											<div class="product__inside__image">
												...
												<div class="product__inside__carousel slide" data-ride="carousel">
													<div class="carousel-inner" role="listbox">
														<div class="item active"> <a href="{{ asset('shop_assets/') }}/product.html"><img src="{{ asset('shop_assets/') }}/images/product/product-1.jpg" alt=""></a> </div>
														<div class="item"> <a href="{{ asset('shop_assets/') }}/product.html"><img src="{{ asset('shop_assets/') }}/images/product/product-2.jpg" alt=""></a> </div>
														<div class="item"> <a href="{{ asset('shop_assets/') }}/product.html"><img src="{{ asset('shop_assets/') }}/images/product/product-3.jpg" alt=""></a> </div>
													</div>
													<!-- Controls --> 
						...
						<div class="col-xl-4 visible-xl">
							...
							<a class="link-img-hover" href="{{ asset('shop_assets/') }}/lookbook.html"><img src="{{ asset('shop_assets/') }}/images/custom/lookbook.jpg" class="img-responsive" alt=""></a>
					...
					<div class="row">
						<div class="banner-carousel">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<a href="{{ asset('shop_assets/') }}/listing.html" class="banner zoom-in">
								<span class="figure">
									<img src="{{ asset('shop_assets/') }}/images/custom/banner-01.jpg" alt=""/>
									<span class="figcaption">
										<span class="block-table">
											<span class="block-table-cell">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<a href="{{ asset('shop_assets/') }}/listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/banner-02.jpg" alt=""/>
										<span class="figcaption">
											<span class="block-table">
												<span class="block-table-cell">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<a href="{{ asset('shop_assets/') }}/listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/banner-03.jpg" alt=""/>
										<span class="figcaption">
											<span class="block-table">
												<span class="block-table-cell">
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets/') }}/product.html"> <img src="{{ asset('shop_assets/') }}/images/product/product-9.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
												<!-- /quick-view --> 
											</div>
						...
						<div class="col-xl-4 visible-xl">
							...
							<div class="text-center promos">
								...
								<div class="promos__image">
									<a href="{{ asset('shop_assets/') }}/lookbook.html" class="link-img-hover">
									<img src="{{ asset('shop_assets/') }}/images/custom/promos.jpg" class="img-responsive" alt="">
									<span class="promos__label">-20%</span>
									</a>
								</div>
								<h2><a href="{{ asset('shop_assets/') }}/lookbook.html">Mauris lacinia lectus</a></h2>
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets/') }}/product.html"> <img src="{{ asset('shop_assets/') }}/images/product/product-11.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
												<!-- /quick-view --> 
											</div>
						...
						<div class="slider-blog slick-arrow-bottom">
								...
								<div class="slider-blog__item">
									<div class="row">
										<div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
											<img src="{{ asset('shop_assets/') }}/images/custom/slider-blog-img01.jpg" alt="">
										</div>
							...
							<a href="{{ asset('shop_assets/') }}/blog-post-right-column.html" class="link-hover-block">
								<div class="slider-blog__item">
									<div class="row">
										<div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
											<img src="{{ asset('shop_assets/') }}/images/custom/slider-blog-img02.jpg" alt="">
										</div>
							...
							<a href="{{ asset('shop_assets/') }}/blog-post-right-column.html" class="link-hover-block">
								<div class="slider-blog__item">
									<div class="row">
										<div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
											<img src="{{ asset('shop_assets/') }}/images/custom/slider-blog-img03.jpg" alt="">
										</div>
										<div class="col-xs-12 col-sm-5 box-data">
      ...
      <!-- Modal (quickViewModal) -->		
		    ...
		    <div class="modal-content modal-md">
		      ...
		      <div class="modal-block">
			      ...
			      <div class="modal-newsletter text-center">
			      	    <img class="logo img-responsive1 replace-2x" src="{{ asset('shop_assets/') }}/images/logo.png" alt=""/>
		...
		<script src="{{ asset('shop_assets/') }}/js/js-index-01.js"></script>		
	</body>
</html>