...
<html lang="en">
	...
	<body>
							...
							<div class="account link-inline hidden mobile-menu-on">
								<div class="dropdown text-right">
									...
									<ul class="dropdown-menu dropdown-menu--xs-full">
										...
										<li><a href="{{ asset('shop_assets') }}/login_form.html"><span class="icon icon-lock"></span>Log In</a></li>
				...
				<div class="container offset-top-5">
					<div class="row">
						...
						<div class="col-xs-12 col-md-3 col-lg-3 col-xl-3 col-sm-3">
							<!-- logo start --> 
							<a href="{{ asset('shop_assets') }}/index.html"><img class="logo replace-2x img-responsive" src="{{ asset('shop_assets') }}/images/logo.png" alt=""/></a> 
							<!-- logo end --> 
						</div>
						<!-- /col-left -->						
						<!-- col-right -->										
									...
									<div class="dropdown text-right">
										...
										<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
											<div class="container">
												...
												<ul>
													<li class="cart__item">
														<div class="cart__item__image pull-left"><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/product/product-1.jpg" alt=""/></a></div>
													...
													<li class="cart__item">
														<div class="cart__item__image pull-left"><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/product/product-2.jpg" alt=""/></a></div>
														<div class="cart__item__control">
															<div class="cart__item__delete"><a href="{{ asset('shop_assets') }}/#" class="icon icon-delete"><span>Delete</span></a></div>
															<div class="cart__item__edit"><a href="{{ asset('shop_assets') }}/#" class="icon icon-edit"><span>Edit</span></a></div>
														</div>
									...
									<div class="responsive-menu mainMenu">									
										...
										<ul class="nav navbar-nav">
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<a href="{{ asset('shop_assets') }}/listing.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">LISTING</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="{{ asset('shop_assets') }}/product.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">PRODUCT</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
													<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-one-third">
														<span class="image-link">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="{{ asset('shop_assets') }}/listing.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">WOMEN’s<span class="badge badge--menu">NEW</span></span></a>
												<ul class="dropdown-menu megamenu" role="menu">
													<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-sm-3">
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle"><span>TOPS</span></a>
														<ul class="megamenu__submenu">
															<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Blouses & Shirts</a></li>
															<li class="level2">
																<a href="{{ asset('shop_assets') }}/listing.html">Dresses</a>
																<ul class="megamenu__submenu">
																	<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
																	<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Bodycon Dresses</a></li>
																	<li class="level3">
																		<a href="{{ asset('shop_assets') }}/listing.html">Midi Dresses</a>
																		<ul class="megamenu__submenu">
																			<li class="dl-back"><a href="{{ asset('shop_assets') }}/listing.html"><span class="icon icon-chevron_left"></span>back</a></li>
																			<li class="level4"><a href="{{ asset('shop_assets') }}/listing.html">Occasion & Cocktail</a></li>
																			<li class="level4"><a href="{{ asset('shop_assets') }}/listing.html">Casual Everyday</a></li>
																			<li class="level4"><a href="{{ asset('shop_assets') }}/listing.html">Going Out & Party Dresses</a></li>
																		</ul>
																	</li>
																	<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Fit & Flare</a></li>
																	<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Shift Dresses</a></li>
																	<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Shirt Dresses</a></li>
																	<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Slip Dresses</a></li>
																	<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Tunic Dresses</a></li>
																</ul>
															</li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Tops & T-shirts</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Sleeveless Tops</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Sweaters & Cardigans</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jackets</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Outerwear</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle"><span>BOTTOMS</span></a>
														<ul class="megamenu__submenu">
															<li class="dl-back"><a href="{{ asset('shop_assets') }}/listing.html"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Trousers</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jeans</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Leggings</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jumpsuit & shorts</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Skirts</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Tights</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle"><span>ACCESSORIES</span></a>
														<ul class="megamenu__submenu">
															<li class="dl-back"><a href="{{ asset('shop_assets') }}/listing.html"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jewellery</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Hats</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Scarves & snoods</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Belts</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Bags</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Shoes</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Sunglasses</a></li>
														</ul>
													</li>
													<li class="col-sm-3 hidden-xs">
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle"><span>FEATURED</span></a>
														<!-- carousel -->
																	...
																	<div class="product">
																		<div class="product__inside">
																			...
																			<div class="product__inside__image">
																				<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-20.jpg" alt=""> </a> 																	
																			</div>
																			<!-- /product image --> 
																			<!-- product name -->
																...
																<div>
																	...
																	<div class="product">
																		<div class="product__inside">
																			<!-- product image -->
																			<div class="product__inside__image">
																				<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-2.jpg" alt=""> </a> 																		
																			</div>
																			<!-- /product image --> 
																			<!-- product name -->
																			<div class="product__inside__name">
																...
																<div>
																	...
																	<div class="product">
																		<div class="product__inside">
																			<!-- product image -->
																			<div class="product__inside__image">
																				<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-4.jpg" alt=""> </a>
													...
													<li class="col-sm-12 hidden-xs">
														<div class="row">
															<div class="col-sm-6"> <a href="{{ asset('shop_assets') }}/#" class="discolor-hover"><img class="img-responsive" src="{{ asset('shop_assets') }}/images/custom/banner-megamenu-01.jpg" alt=""/></a> </div>
															<div class="col-sm-6"> <a href="{{ asset('shop_assets') }}/#" class="discolor-hover"><img class="img-responsive" src="{{ asset('shop_assets') }}/images/custom/banner-megamenu-02.jpg" alt=""/></a> </div>
														</div>
													</li>
												</ul>
											</li>
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="{{ asset('shop_assets') }}/listing.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">MEN’s<span class="badge badge--menu badge--color">SALE</span></span></a>
												<ul class="dropdown-menu megamenu" role="menu">
													<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-sm-3">												
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle">
															<span>TOPS</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="{{ asset('shop_assets') }}/images/custom/mens-category-1.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jackets</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Shirts</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Sweaters & Cardigans</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">T-shirts</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle">
															<span>BOTTOMS</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="{{ asset('shop_assets') }}/images/custom/mens-category-2.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Trousers</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jeans</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Skirts</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Swimwear</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="{{ asset('shop_assets') }}/#" class="megamenu__subtitle">
															<span>ACCESSORIES</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="{{ asset('shop_assets') }}/images/custom/mens-category-3.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Bags</a></li>
													...
													<li class="col-sm-3 hidden-xs">
														<a href="{{ asset('shop_assets') }}/listing.html" class="megamenu__subtitle"><span>Specials</span></a>
														<div class="vertical-carousel vertical-carousel-1 special-carousel">
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-left"><a href="{{ asset('shop_assets') }}/product.html"><img src="{{ asset('shop_assets') }}/images/product/product-120x150-1.jpg" alt=""></a></div>
															...
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-left"><a href="{{ asset('shop_assets') }}/product.html"><img src="{{ asset('shop_assets') }}/images/product/product-120x150-2.jpg" alt=""></a></div>
																<div class="product__label product__label--sale"> <span>Sale</span></div>
																<div class="vertical-carousel__item__title">
																	<h2><a href="{{ asset('shop_assets') }}/product.html">Incididunt ut labore et dolore magna aliqua</a></h2>
																</div>
																<div class="price-box">$26.00 <span class="price-box__old">$28.00</span></div>
															</div>
														</div>
													...
													<li class="col-sm-12 hidden-xs">
														...
														<ul class="list-inline brands-list">
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-01.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-03.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-02.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-05.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-04.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-06.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-07.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-08.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-09.png" alt=""></a></li>
															<li><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-10.png" alt=""></a></li>
														</ul>
													</li>
												</ul>
											</li>
					...
					<aside class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-2 ">						
						...
						<nav class="navbar navbar-vertical mobile-menu-off">
							<div class="responsive-menu mainMenu">
								...
								<ul class="nav navbar-nav">
									<li class="dl-close"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-close"></span>close</a></li>
									<li class="dropdown dropdown-mega-menu">
										<a href="{{ asset('shop_assets') }}/index.html" class="dropdown-toggle" data-toggle="dropdown">
											LAYOUT
									...
									<li class="dropdown dropdown-mega-menu">
										<a href="{{ asset('shop_assets') }}/listing.html" class="dropdown-toggle" data-toggle="dropdown">
											LISTING
											<span class="icon icon-navigate_next pull-right"></span>
										</a>
										<ul class="dropdown-menu megamenu image-links" role="menu">
									...
									<li class="dropdown dropdown-mega-menu">
										<a href="{{ asset('shop_assets') }}/product.html" class="dropdown-toggle" data-toggle="dropdown">
											PRODUCT
											<span class="icon icon-navigate_next pull-right"></span>
										</a>
									...
									<li class="dropdown dropdown-mega-menu">
										<a href="{{ asset('shop_assets') }}/blog-layout-1.html" class="dropdown-toggle" data-toggle="dropdown">
											BLOG
											<span class="icon icon-navigate_next pull-right"></span>
										</a>
										<ul class="dropdown-menu megamenu image-links image-links-listing" role="menu">
									...
									<li class="dropdown dropdown-mega-menu">
										<a href="{{ asset('shop_assets') }}/gallery-layout-1.html" class="dropdown-toggle" data-toggle="dropdown">
											GALLERY
											<span class="icon icon-navigate_next pull-right"></span>
										</a>
										<ul class="dropdown-menu megamenu image-links image-links-listing" role="menu">
									...
									<li class="dropdown dropdown-mega-menu dropdown-two-col">
										<a href="{{ asset('shop_assets') }}/about.html" class="dropdown-toggle" data-toggle="dropdown">
											PAGES
											<span class="icon icon-navigate_next pull-right"></span>
										</a>
										<ul class="dropdown-menu multicolumn two-col" role="menu">
										...
										<ul class="dropdown-menu megamenu" role="menu">
												...
												<li class="col-sm-3">
													...
													<ul class="megamenu__submenu">
														...
														<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Blouses & Shirts</a></li>
														<li class="level2">
															<a href="{{ asset('shop_assets') }}/#">Dresses</a>
															<ul class="megamenu__submenu">
																<li class="dl-back"><a href="{{ asset('shop_assets') }}/#"><span class="icon icon-chevron_left"></span>back</a></li>
																<li class="level3"><a href="{{ asset('shop_assets') }}/listing.html">Bodycon Dresses</a></li>
																<li class="level3">
																	<a href="{{ asset('shop_assets') }}/#">Midi Dresses</a>
																	<ul class="megamenu__submenu">
																		<li class="dl-back"><a href="{{ asset('shop_assets') }}/listing.html"><span class="icon icon-chevron_left"></span>back</a></li>
																		<li class="level4"><a href="{{ asset('shop_assets') }}/listing.html">Occasion & Cocktail</a></li>
																		<li class="level4"><a href="{{ asset('shop_assets') }}/listing.html">Casual Everyday</a></li>
												...
												<li class="col-sm-3">
													<a href="{{ asset('shop_assets') }}/#" class="megamenu__subtitle"><span>BOTTOMS</span></a>
													<ul class="megamenu__submenu">
														<li class="dl-back"><a href="{{ asset('shop_assets') }}/listing.html"><span class="icon icon-chevron_left"></span>back</a></li>
														<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Trousers</a></li>
														<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jeans</a></li>
												...
												<li class="col-sm-3">
													<a href="{{ asset('shop_assets') }}/#" class="megamenu__subtitle"><span>ACCESSORIES</span></a>
													<ul class="megamenu__submenu">
														<li class="dl-back"><a href="{{ asset('shop_assets') }}/listing.html"><span class="icon icon-chevron_left"></span>back</a></li>
														<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Jewellery</a></li>
														<li class="level2"><a href="{{ asset('shop_assets') }}/listing.html">Hats</a></li>
						...
						<div class="bannerAsid nav-dot hidden-sm  hidden-xs">
							...
							<div class="text-center">
								<a href="{{ asset('shop_assets') }}/listing.html"><img class="img-responsive-inline" src="{{ asset('shop_assets') }}/images/custom/banner-aside-01.jpg" alt=""></a>									
							</div>
							<!-- /slide-->
							<!-- slide-->
							<div class="text-center">
								<a href="{{ asset('shop_assets') }}/listing.html"><img class="img-responsive-inline" src="{{ asset('shop_assets') }}/images/custom/banner-aside-02.jpg" alt=""></a>
							</div>
							<!-- /slide-->
							<!-- slide-->
							<div class="text-center">
								<a href="{{ asset('shop_assets') }}/listing.html"><img class="img-responsive-inline" src="{{ asset('shop_assets') }}/images/custom/banner-aside-03.jpg" alt=""></a>
							</div>
							<!-- /slide-->
						</div>						
						<!--======= /banner-asid =======-->
						...
						<div class="fill-bg-custom aside-inner color-white">
							...
							<div class="testimonialsAsid nav-dot nav-dot-invert">
								<!-- slide-->
								<a href="{{ asset('shop_assets') }}/blog-post-right-column.html" class="link-hover-block">
									<div class="text-center">
										<img class="img-responsive-inline" src="{{ asset('shop_assets') }}/images/custom/slider-blog-img01.jpg" alt="">
										<p>
								...
								<a href="{{ asset('shop_assets') }}/blog-post-right-column.html" class="link-hover-block">
									<div class="text-center">
										<img class="img-responsive-inline" src="{{ asset('shop_assets') }}/images/custom/slider-blog-img02.jpg" alt="">
										<p>
								...
								<a href="{{ asset('shop_assets') }}/blog-post-right-column.html" class="link-hover-block">
									<div class="text-center">
										<img class="img-responsive-inline" src="{{ asset('shop_assets') }}/images/custom/slider-blog-img03.jpg" alt="">
										<p>
							...
							<div class="col-sm-3 col-xl-6">
								...
								<div class="recent-post-box">
									<div class="col-lg-12 col-xl-12">
										...
										<span class="figure">
										<img src="{{ asset('shop_assets') }}/images/custom/recent-posts-01.jpg" alt="">
							...
							<div class="col-sm-3 col-xl-6">
								...
								<div class="recent-post-box">
									<div class="col-lg-12 col-xl-12">
										<a href="{{ asset('shop_assets') }}/blog-post-right-column.html">
										<span class="figure">
										<img src="{{ asset('shop_assets') }}/images/custom/recent-posts-02.jpg" alt="">
										<span class="figcaption label-top-left">
										<span>
										<b>26</b>
										<em>jun</em>
							...
							<div class="col-sm-3 col-xl-6">
								...
								<div class="recent-post-box">
									<div class="col-lg-12 col-xl-12">
										<a href="{{ asset('shop_assets') }}/blog-post-right-column.html">
										<span class="figure">
										<img src="{{ asset('shop_assets') }}/images/custom/recent-posts-03.jpg" alt="">
										<span class="figcaption label-top-left">
										<span>
										<b>26</b>
										<em>jun</em>
									...
									<div class="col-lg-12 col-xl-12">
										<div class="recent-post-box__text">
											<h4><a href="{{ asset('shop_assets') }}/blog-post-right-column.html">dolore magna aliqua</a></h4>
											<div class="author">by <b>Admin</b></div>
											<p>
												Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec eros tellus, scelerisque nec, rhoncus eget, laoreet sit amet.
											</p>
								...
								<div class="tp-banner">
									<ul>
										...
										<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
											<!-- MAIN IMAGE --> 
											<img src="{{ asset('shop_assets') }}/images/slides/02/slide-1.jpg"  alt="slide1"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" > 
											<!-- LAYERS --> 
											<!-- TEXT -->
											<div class="tp-caption lfl stb" 
												...
												<a href="{{ asset('shop_assets') }}/listing.html" class="link-button button--border-thick" data-text="Shop now!">Shop now!</a>
											</div>
										</li>
										<!-- /SLIDE -1 -->
										<!-- SLIDE 2  -->            
										<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
											<!-- MAIN IMAGE --> 
											<img src="{{ asset('shop_assets') }}/images/slides/02/slide-2.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
											<!-- LAYERS -->
											<!-- TEXT -->
											<div class="tp-caption lfr stb" 
												...
												<a href="{{ asset('shop_assets') }}/listing.html" class="link-button button--border-thick pull-right" data-text="Shop now!">Shop now!</a>
											</div>							
										</li>
										<!-- /SLIDE 2  -->
										<!-- SLIDE 3  -->
										<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
											<!-- MAIN IMAGE --> 
											<img src="{{ asset('shop_assets') }}/images/slides/02/slide-3.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
											<!-- LAYERS --> 
											<!-- TEXT -->
											<div class="tp-caption lfb stb" 
												...
												<div class="text-center"><a href="{{ asset('shop_assets') }}/listing.html" class="link-button button--border-thick" data-text="Shop now!">Shop now!</a></div>
											</div>	
										</li>
										<!-- /SLIDE 3  -->		  
									</ul>
							...
							<div class="row">
								<div class="category-carousel">
									<div class="col-sm-4 col-md-4 col-lg-4">
										<a href="{{ asset('shop_assets') }}/listing.html" class="banner zoom-in">
										<span class="figure">
											<img src="{{ asset('shop_assets') }}/images/custom/category-4.jpg" alt=""/>
									...
									<div class="col-sm-4 col-md-4 col-lg-4">
										<a href="{{ asset('shop_assets') }}/listing.html" class="banner zoom-in">
										<span class="figure">
											<img src="{{ asset('shop_assets') }}/images/custom/category-5.jpg" alt=""/>
											<span class="figcaption">
												<span class="block-table">
													<span class="block-table-cell">
									...
									<div class="col-sm-4 col-md-4 col-lg-4">
										<a href="{{ asset('shop_assets') }}/listing.html" class="banner zoom-in">
										<span class="figure">
										<img src="{{ asset('shop_assets') }}/images/custom/category-6.jpg" alt=""/>
											<span class="figcaption">
												<span class="block-table">
													<span class="block-table-cell">
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-10.jpg" alt=""> </a> 
												<!-- quick-view --> 
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-21.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
												<!-- /quick-view --> 
											</div>
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-6.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
												<!-- /quick-view --> 
											</div>
								...
								<div class="col-lg-3">
									...
									<div class="product sold-out">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-3.jpg" alt=""> </a> 
												<!-- label sold-out -->
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-12.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
												<!-- /quick-view --> 
											</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-8.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
														<!-- /quick-view --> 
													</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-1.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-5.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="{{ asset('shop_assets') }}/product.html"> <img src="{{ asset('shop_assets') }}/images/product/product-7.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="{{ asset('shop_assets') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>   
														<!-- /quick-view --> 
													</div>
						...
						<div class="content section-indent-bottom">
							<div class="row">
								<div class="brands-carousel">
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-01.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-02.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-03.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-04.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-05.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-06.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-07.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-08.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-09.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-10.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-01.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-02.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-03.png" alt=""></a></div>
									<div><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/custom/brand-04.png" alt=""></a></div>
							...
							<div class="mobile-collapse">
								...
								<div class="mobile-collapse__content">
									...
									<address class="box-address">
										...
										<span class="icon icon-markunread"></span> <a class="color" href="{{ asset('shop_assets') }}/mailto:info@mydomain.com">info@mydomain.com</a>
									</address>
									<!-- /address -->
									<!-- social-icon -->
			...
			<div class="container">
				...
				<div class="compared-product-row">
					<div class="compared-product">
						<a href="{{ asset('shop_assets') }}/#" class="compared-product__delete icon icon-delete"></a>
						<div class="compared-product__image"><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/product/product-1.jpg" alt=""/></a></div>
						<a href="{{ asset('shop_assets') }}/#" class="compared-product__name">Quis nostrud exercitation ullamco labori.</a>
					</div>
					<div class="compared-product">
						<a href="{{ asset('shop_assets') }}/#" class="compared-product__delete icon icon-delete"></a>
						<div class="compared-product__image"><a href="{{ asset('shop_assets') }}/#"><img src="{{ asset('shop_assets') }}/images/product/product-1.jpg" alt=""/></a></div>
				...
				<div class="compareSlide__bot">
					<a href="{{ asset('shop_assets') }}/#" class="clear-all icon icon-delete"><span>Clear All</span></a>
					<a href="{{ asset('shop_assets') }}/#" class="btn btn--ys btn-compare"><span class="icon icon-shopping_basket"></span> Compare</a>
				</div>
			</div>
		</div>
		  ...
		  <div class="modal-dialog white-modal modal-sm">
		    <div class="modal-content ">
		      ...
		      <div class="modal-footer text-center">		       	
		        <a href="{{ asset('shop_assets') }}/shopping-cart-right-column.html" class="btn btn--ys btn--full btn--lg">go to cart</a>
		      </div>
		    </div>
		  </div>
		</div>
		      ...
		      <form>
			      <div class="modal-body indent-bot-none">
			        ...
			        <ul class="list-arrow-right">
			        	<li><a href="{{ asset('shop_assets') }}/#">Forgot your username?</a></li>
			        	<li><a href="{{ asset('shop_assets') }}/#">Forgot your password?</a></li>
			        	<li><a href="{{ asset('shop_assets') }}/#">Create an account</a></li>
			        </ul>
			      </div>			      
			  </form>
		    </div>
      ...
      <!-- Modal (quickViewModal) -->		
		  ...
		  <div class="modal-dialog white-modal">
		    <div class="modal-content modal-md">
		      <div class="modal-bg-image bottom-right"> 
			      <img  src="{{ asset('shop_assets') }}/images/custom/newsletter-bg.png" alt="" class="img-responsive"> 
			  </div>
		      <div class="modal-block">
			      ...
			      <div class="modal-newsletter text-center">
			      	    <img class="logo replace-2x img-responsive1" src="{{ asset('shop_assets') }}/images/logo.png" alt=""/>
		...
		<script type="text/javascript" src="{{ asset('shop_assets') }}/external/rs-plugin/js/jquery.themepunch.tools.min.js"></script> 
		<script type="text/javascript" src="{{ asset('shop_assets') }}/external/rs-plugin/js/jquery.themepunch.revolution.min.js"></script> 
		<!-- Custom --> 
		<script src="{{ asset('shop_assets') }}/js/custom.js"></script>
		<script src="{{ asset('shop_assets') }}/js/js-index-02.js"></script>
	</body>
</html>
