		...
		<div id="pageContent">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-6">
						...
						<div class="banner-slider banner-slider-button">
							<div>
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in font-size-responsive">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-04.jpg" alt=""/>
							...
							<div>
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in font-size-responsive">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-05.jpg" alt=""/>
										<span class="figcaption">
											<span class="btn-right-bottom">
												<span class="btn btn--ys btn--l btn--bg-yellow">Shop now!</span>
											</span>
							...
							<div>
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in font-size-responsive">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-06.jpg" alt=""/>
										<span class="figcaption">
											<span class="btn-right-bottom">
					...
					<div class="col-xs-12 col-sm-12 col-md-6">
						<div class="row">
							...
							<div class="col-sm-6  col-md-6">
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-08.jpg" alt=""/>
						...
						<div class="row">
							<div class="col-md-12">
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-09.jpg" alt=""/>
										<span class="figcaption">
											<span class="block-table">
												<span class="block-table-cell">
			...
			<div class="container-fluid box-baners content offset-top-0 ">
				<div class="row">					
					<div class="col-xs-12">
						<!-- banner -->
						<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner banner-bg image-bg zoom-in" data-image="{{ asset('shop_assets/') }}/images/custom/layout11/banner-23.jpg">
							<span class="figure">
								<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-23.jpg" alt=""/>
								<span class="figcaption">
									<span class="block-table">
					...
					<div class="row">
						<div class="bannerCarousel box-baners ">
							...
							<div class="col-md-3">
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in">
								<span class="figure">
									<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-11.jpg" alt=""/>
									<span class="figcaption">
										<span class="block-table">
											<span class="block-table-cell">
							...
							<div class="col-md-3">
								<a href="{{ asset('shop_assets/') }}/listing-layout11.html" class="banner zoom-in">
									<span class="figure">
										<img src="{{ asset('shop_assets/') }}/images/custom/layout11/banner-13.jpg" alt=""/>
										<span class="figcaption">
											<span class="block-table">
												<span class="block-table-cell">
