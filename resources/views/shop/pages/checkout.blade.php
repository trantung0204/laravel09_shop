				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
							<!-- logo start --> 
							<a href="{{ route('shop.index') }}"><img class="logo replace-2x img-responsive" src="{{ asset('shop_assets/') }}/images/logo.png" alt=""/> </a> 
							<!-- logo end --> 
						</div>
						...
						<div class="panel-group" id="checkout">
			              <div class="panel panel-checkout" role="tablist">
			                ...
			                <div class="panel-heading active" role="tab">
			                  <h4 class="panel-title"> <a role="button" data-toggle="collapse" href="{{ asset('shop_assets/') }}/#collapseOne">ESTIMATE SHIPPING AND TAX</a> </h4>
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel">
			                  <div class="panel-body">
			                    <form action="" method="post">
			                    	<a class="pull-right link-functional" href="{{ asset('shop_assets/') }}/#">
			              ...
			              <div class="panel panel-checkout" role="tablist">
			                ...
			                <div class="panel-heading" role="tab">
			                  <h4 class="panel-title"> <a role="button" data-toggle="collapse" href="{{ asset('shop_assets/') }}/#collapseFive">ORDER REVIEW</a> </h4>
			                ...
			                <div id="collapseFive" class="panel-collapse collapse" role="tabpanel">
			                  <div class="panel-body">
			                    <p class="clearfix">
			                    	 <a class="pull-right link-functional link-functional-bottom" href="{{ asset('shop_assets/') }}/#">
				                    	<span class="icon icon-create"></span>Edit
				                    </a>
			                    </p>
												...
												<tr>												
													<td>
														<h5 class="order-review-table__product-name text-left text-uppercase">
															<a href="{{ asset('shop/product') }}{{'/'.str_slug($item->name)}}">{{$item->name}}</a>
														</h5>
										...
										<div class="pull-right col-xl-6 col-lg-9 col-md-9 col-xs-12 btn-top">
											<div class="order-review-total">
												<table class="table-total">
													<tbody>
														<tr>
															...
															<td class="text-right">${{$subtotalCarts}}</td>
														</tr>
														<tr>
															<th class="text-left">Tax:</th>
															<td class="text-right">${{$taxCarts}}</td>
														</tr>
													</tbody>
													<tfoot>
														<tr>
												...
												<p class="clearfix text-right">
													<a href="{{ asset('shop_assets/') }}/#" class="btn btn--ys btn--xl">PLACE ORDER <span class="icon icon--flippedX icon-reply"></span></a>
												</p>
												<div class="text-right link-top">
													<span class="color-dark">Forgot an Item?</span> <a class="link-underline" href="{{ asset('shop_assets/') }}/#">Edit Your Cart</a>
												</div>
											</div>
										</div>
									</div>
					...
					<aside class="col-md-4 col-lg-4 shopping_cart-aside">
						...
						<div class="box-border box-border--padding fill-bg">							
							...
							<div class="block-underline-top">
								<a class="pull-right link-functional" href="{{ asset('shop_assets/') }}/#">Change</a>
								<h6 class="small">BILLING ADDRESS</h6>
								<ul class="categories-list">
									<li><a href="{{ asset('shop_assets/') }}/#">Lorem ipsum dolor sit amet </a></li>
									<li><a href="{{ asset('shop_assets/') }}/#">Conse ctetur adipisicing </a></li>
									<li><a href="{{ asset('shop_assets/') }}/#">Elit sed do eiusmod tempor</a></li>
									<li><a href="{{ asset('shop_assets/') }}/#">Incididunt ut labore </a></li>
									<li><a href="{{ asset('shop_assets/') }}/#">Et dolore magna aliqua</a></li>
								</ul>
							</div>						
							<!-- / -->
							<!--  -->
