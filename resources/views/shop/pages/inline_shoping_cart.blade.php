								...
								<div class="cart link-inline">
									<div class="dropdown text-right">
										...
										<span class="badge badge--cart">{{$countCarts}}</span>
										</a>
													...
													@foreach ($carts as $item)
														<li class="cart__item">
															...
															<div class="cart__item__info">
																...
																<div class="cart__item__info__qty"><span class="info-label">Qty:</span><input type="text" class="input--ys" value='{{$item->qty}}' /></div>
