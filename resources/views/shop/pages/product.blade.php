				...
				<div class="container">
					<div class="row product-info-outer">
						<div id="productPrevNext" class="hidden-xs hidden-sm">
							<a href="{{ asset('shop_assets/') }}/#" class="product-prev"><img src="{{ asset('shop_assets/') }}/images/product/product-2.jpg" alt="" /></a>
							<a href="{{ asset('shop_assets/') }}/#" class="product-next"><img src="{{ asset('shop_assets/') }}/images/product/product-3.jpg" alt="" /></a>
						</div>
						<div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
							<div class="row">
								<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 hidden-xs">
									<div class="product-main-image">
										<div class="product-main-image__item"><img class="product-zoom" src='{{ asset('shop_assets/') }}/images/product/product-big-1.jpg' data-zoom-image="{{ asset('shop_assets/') }}/images/product/product-big-1-zoom.jpg" alt="" /></div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-13.jpg" alt=""> </a> 
										<!-- quick-view --> 
									...
									<!-- product name -->
									<div class="product__inside__name">
										<h2><a href="{{ asset('shop_assets/') }}/#">Mauris lacinia lectus</a></h2>
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-14.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-15.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-16.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product sold-out">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-17.jpg" alt=""> </a> 
										<!-- label sold-out -->
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-18.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-one-six">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="{{ asset('shop_assets/') }}/#"> <img src="{{ asset('shop_assets/') }}/images/product/product-6.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="{{ asset('shop_assets/') }}/#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
										<!-- /quick-view --> 
									</div>
